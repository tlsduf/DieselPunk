...
template<> DRAGONIKPLUGIN_API UScriptStruct* StaticStruct<FAnimNode_DragonPhysicsSolver>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonPhysicsSolver_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonPhysicsSolver_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonPhysicsSolver_h_4042864640(TEXT("/Script/DragonIKPlugin"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonPhysicsSolver_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonPhysicsSolver_h_Statics::ScriptStructInfo),
		nullptr, 0);
