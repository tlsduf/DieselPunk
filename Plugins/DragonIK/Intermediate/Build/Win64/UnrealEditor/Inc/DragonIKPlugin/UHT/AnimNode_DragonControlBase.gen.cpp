...
template<> DRAGONIKPLUGIN_API UScriptStruct* StaticStruct<FAnimNode_DragonControlBase>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonControlBase_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonControlBase_h_Statics::ScriptStructInfo[] = {
		{ FSocketDragonReference::StaticStruct, Z_Construct_UScriptStruct_FSocketDragonReference_Statics::NewStructOps, TEXT("SocketDragonReference"), &Z_Registration_Info_UScriptStruct_SocketDragonReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSocketDragonReference), 3794039168U) },
		{ FBoneDragonSocketTarget::StaticStruct, Z_Construct_UScriptStruct_FBoneDragonSocketTarget_Statics::NewStructOps, TEXT("BoneDragonSocketTarget"), &Z_Registration_Info_UScriptStruct_BoneDragonSocketTarget, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBoneDragonSocketTarget), 2778558905U) },
		{ FAnimNode_DragonControlBase::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_DragonControlBase_Statics::NewStructOps, TEXT("AnimNode_DragonControlBase"), &Z_Registration_Info_UScriptStruct_AnimNode_DragonControlBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_DragonControlBase), 2502693419U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonControlBase_h_165117512(TEXT("/Script/DragonIKPlugin"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonControlBase_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Desktop_Unreal_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_AnimNode_DragonControlBase_h_Statics::ScriptStructInfo),
		nullptr, 0);
