...
void FCharacterFootStep_DelegateWrapper(const FMulticastScriptDelegate& CharacterFootStep, FName bone_name, FTransform foot_transform, float height_difference, FHitResult hit_info)
{
	...
	struct Z_CompiledInDeferFile_FID_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_DragonIKFootStepsComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_DragonIKFootStepsComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_DragonIKFootStepsComponent_h_2453388953(TEXT("/Script/DragonIKPlugin"),
		Z_CompiledInDeferFile_FID_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_DragonIKFootStepsComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_DieselPunk_Plugins_DragonIK_Source_DragonIKPlugin_Public_DragonIKFootStepsComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
