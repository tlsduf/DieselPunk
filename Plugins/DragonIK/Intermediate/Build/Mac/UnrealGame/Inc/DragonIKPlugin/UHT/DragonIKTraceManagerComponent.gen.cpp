...
void FDragonIKFootSolverTraceData_DelegateWrapper(const FMulticastScriptDelegate& DragonIKFootSolverTraceData, TArray<FDragonIKTraceKeyValuePair> const& hit_data_pair)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDragonIKTraceManagerComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDragonIKTraceManagerComponent_SpineSolverTraceData, "SpineSolverTraceData" }, // 1218012502
	};
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::EnumInfo[] = {
		{ EDragonIKTraceMType_StaticEnum, TEXT("EDragonIKTraceMType"), &Z_Registration_Info_UEnum_EDragonIKTraceMType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3831600239U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::ScriptStructInfo[] = {
		{ FDragonIKTraceKeyValuePair::StaticStruct, Z_Construct_UScriptStruct_FDragonIKTraceKeyValuePair_Statics::NewStructOps, TEXT("DragonIKTraceKeyValuePair"), &Z_Registration_Info_UScriptStruct_DragonIKTraceKeyValuePair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDragonIKTraceKeyValuePair), 2344855598U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDragonIKTraceManagerComponent, UDragonIKTraceManagerComponent::StaticClass, TEXT("UDragonIKTraceManagerComponent"), &Z_Registration_Info_UClass_UDragonIKTraceManagerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDragonIKTraceManagerComponent), 1205935614U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_940210850(TEXT("/Script/DragonIKPlugin"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DragonIKPlugin_Source_DragonIKPlugin_Public_DragonIKTraceManagerComponent_h_Statics::EnumInfo));
