...
namespace UtilCollision
{
	...
	void CapsuleSweepMulti(TArray<FHitResult>& OutHitResults, const FVector& InStartLocation, const FVector& InEndLocation, const float& InCapsuleRadius, bool InPlayerSkill, bool InDebugOnOff);
